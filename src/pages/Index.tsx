          ...
          <nav className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <svg className="h-8 w-8 text-primary" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="16" cy="16" r="10" fill="currentColor" fillOpacity="0.1"/>
                <path d="M10 16c0-3.3 2.7-6 6-6s6 2.7 6 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                <circle cx="16" cy="16" r="2" fill="currentColor"/>
                <path d="M8 8l2 2M22 8l2 2M8 24l2-2M22 24l2-2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
              </svg>
