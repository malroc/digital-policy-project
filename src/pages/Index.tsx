      ...
      <section id="portfolio" className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Примеры наших работ - от собственных продуктов до заказных решений</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/50">
              <CardHeader>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <span className="font-semibold text-blue-500">Цифровая Полития</span>
            </div>
            <div className="text-sm text-muted-foreground text-right">
              <p>© 2025 АО "Цифровая Полития". Все права защищены.</p>
              <p>ИНН: 5260499084</p>
              <p>603000, Нижний Новгород, ул. Малая Покровская, д. 18, офис 313</p>
            </div>
          </div>
        </div>
      </footer>
